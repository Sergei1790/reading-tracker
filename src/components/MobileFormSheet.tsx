...
export default function MobileFormSheet() {
    ...
    return (
        <>
            <button type="button" onClick={() => setOpen(!open)} className="w-full bg-sky-600/80 hover:bg-sky-500/80 text-white py-3 rounded-xl text-sm font-medium cursor-pointer mb-4 md:hidden transition-colors">
                {open ? 'Close' : '+ Add New'}
            </button>
